...
function configureVirtualbox() {
	...
	vboxmanage import ~/S4KUR4/Agent.ova && vboxmanage modifyvm "Agent" --name "cuckoo1" && vboxmanage startvm "cuckoo1" --type headless
	sleep 3m
...
echo -e "\033[41;30m------------------------------\033[0m"
echo -e "\033[41;30m Step 2: Configure VirtualBox \033[0m"
echo -e "\033[41;30m------------------------------\033[0m"
configureVirtualbox ~/S4KUR4/Agent.ova

echo -e "\033[41;30m---------------------------\033[0m"
echo -e "\033[41;30m Step 3: Configure Network \033[0m"
echo -e "\033[41;30m---------------------------\033[0m"
configureNetwork

echo -e "\033[41;30m--------------------------\033[0m"
echo -e "\033[41;30m Step 4: Configure Cuckoo \033[0m"
echo -e "\033[41;30m--------------------------\033[0m"
configCuckoo

echo -e "\033[41;30m-----------------------------\033[0m"
echo -e "\033[41;30m Step 5: Run Cuckoo services \033[0m"
echo -e "\033[41;30m-----------------------------\033[0m"
